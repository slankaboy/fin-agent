...
class FinAgent:
    ...
    def _get_system_content(self):
        ...
        return (
            ...
            "For semantic search over financial reports and research documents, use 'index_document_to_rag' to index a PDF/TXT file first, then 'search_knowledge' to retrieve relevant content by natural language query. Use 'list_rag_sources' to see what is already indexed."
